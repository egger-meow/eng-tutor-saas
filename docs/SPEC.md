...
New production authoring uses Engine 1.4.0, schema 2.3.0, and prompt 2.9.1. Prompt 2.4.0 through 2.8.0 sources are frozen historical inputs; historical packages remain readable but are not valid targets for new authoring. Prompt 2.8.0 remains the inherited recency-aware overlay, while Prompt 2.9.1 adds the authoritative CAP precedent-first assessment contract without changing the canonical grounding shape.
