...
for (const file of ['smoke.sql', 'diversity-format-memory.sql', 'diversity-release-compatibility.sql', 'assessment-foundation.sql', 'assessment-conformance.sql', 'assessment-curated-rpcs.sql']) {
