 ...
 *
 * IMPORTANT: the published all-subject answer tables change visual column positions
 * after English Listening, Mathematics, and Chinese end. These values are locked by
 * full 43-question regression tests so future transcription cannot drift by column.
 */
