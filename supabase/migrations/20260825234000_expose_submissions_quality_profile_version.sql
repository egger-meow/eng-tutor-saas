-- Migration: Expose quality_profile_version & release_id in admin_get_curriculum_submissions RPC and update provenance validation for Schema 2.3 / Prompt 2.7
