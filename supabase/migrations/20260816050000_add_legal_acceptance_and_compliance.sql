-- Migration: Add legal acceptance tracking (terms_version, privacy_version, legal_accepted_at)
-- and data protection compliance safeguards.
...
-- RPC for durable legal acceptance recording
