-- Migration: Advance Scheduled Work generation provenance to release rel_1.4.0
...
begin
  ...
  target_rel_id := coalesce(claim_snapshot.generation_context->>'targetReleaseId', 'rel_1.4.0');
