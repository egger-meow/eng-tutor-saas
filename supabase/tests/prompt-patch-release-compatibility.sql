...
declare
 ...
 old_ct jsonb:='{"releaseId":"rel_1.9.0","schemaVersion":"2.6.0","promptVersion":"2.14.0","engineVersion":"1.9.0","workerVersion":"1.8.0","rendererVersion":"1.6.0","bundleVersion":"2.14.0-prod","bundleSha256":"971e2b7d3f497c9448bf95171b5ab9258d278312bd3ea43d2f1d5ba531ed526c"}';
 new_ct jsonb:='{"releaseId":"rel_1.9.1","schemaVersion":"2.6.0","promptVersion":"2.14.1","engineVersion":"1.9.0","workerVersion":"1.8.0","rendererVersion":"1.6.1","bundleVersion":"2.14.1-prod","bundleSha256":"d72ca08a83b41c34f64d703541f34d6120d629bc2b0d4919037a749808591211"}';
...
begin
 ...
 raise notice 'PASS: prompt patch release on both claim paths, target acceptance, six mismatches per path, rel_1.9.0 immutability';
end;
$test$;
rollback;
