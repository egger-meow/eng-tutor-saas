...
Prompt Suite `2.14.0` is the prepared, not-yet-activated consolidated baseline for Schema 2.6.0:
...
1. **Deliberate Response Format Selection**:
   ...
   - Maps learning tasks (timelines, creation steps, comparisons, evidence deductions, cause chains, category sorting, before/after, turning points) directly to Schema 2.6.0 layout primitives (`lines`, `table`, `organizer`, `sequence`).
