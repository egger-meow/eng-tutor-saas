# Prompt Suite 2.13.1: Formats Decision & Shared Selective Precedent Authoring

Prompt Suite `2.13.1` is the active consolidated production baseline for Schema 2.5.0:
