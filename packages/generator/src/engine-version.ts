 ...
 *
 * - `CURRENT_ENGINE_VERSION`: Semantic version of the generation & pedagogy engine (currently '1.9.0')
 * - `CURRENT_SCHEMA_VERSION`: Canonical schema version for curriculum package structure ('2.6.0')
 * - `CURRENT_PROMPT_VERSION`: Active consolidated prompt suite version ('2.14.0')
 * - `CURRENT_ERA_TAG`: Stable machine era identifier ('engine_v1')
 * - `CURRENT_QUALITY_PROFILE_VERSION`: Quality profile revision ('1.2.0')
 * - `CURRENT_WORKER_VERSION`: Semantic version of the authoring worker ('1.8.0')
 */

export const CURRENT_RELEASE_ID = 'rel_1.9.0'
export const CURRENT_ENGINE_VERSION = '1.9.0'
export const CURRENT_SCHEMA_VERSION = '2.6.0'
export const CURRENT_PROMPT_VERSION = '2.14.0'
export const CURRENT_ERA_TAG = 'engine_v1' as const
export const CURRENT_QUALITY_PROFILE_VERSION = '1.2.0'
export const CURRENT_WORKER_VERSION = '1.8.0'
export const CURRENT_PDF_RENDERER_VERSION = '1.6.0'
