 ...
 * - `CURRENT_PROMPT_VERSION`: Active consolidated prompt suite version ('2.14.1')
...
export const CURRENT_RELEASE_ID = 'rel_1.9.1'
export const CURRENT_ENGINE_VERSION = '1.9.0'
export const CURRENT_SCHEMA_VERSION = '2.6.0'
export const CURRENT_PROMPT_VERSION = '2.14.1'
...
export const CURRENT_PDF_RENDERER_VERSION = '1.6.1'
