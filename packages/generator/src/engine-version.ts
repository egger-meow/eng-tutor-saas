 ...
 *
 * - `CURRENT_ENGINE_VERSION`: Semantic version of the generation & pedagogy engine (currently '1.0.1')
 * - `CURRENT_SCHEMA_VERSION`: Canonical schema version for curriculum package structure ('2.2.0')
 * - `CURRENT_PROMPT_VERSION`: Active prompt suite version ('2.4.0')
 * - `CURRENT_ERA_TAG`: Stable machine era identifier ('engine_v1')
 * - `CURRENT_QUALITY_PROFILE_VERSION`: Quality profile revision ('1.1.0')
 */

export const CURRENT_ENGINE_VERSION = '1.0.1'
export const CURRENT_SCHEMA_VERSION = '2.2.0'
export const CURRENT_PROMPT_VERSION = '2.4.0'
