...
describe('production failure regressions', () => {
  ...
  it('rejects bare CURRENT_PROMPT_VERSION (2.14.1) packages missing mandatory critic dimensions', () => {
    const pkg = canonicalPackage()
  ...
  describe('Prompt 2.14.1 cross-stage lexical retrieval quality', () => {
  ...
  describe('Prompt 2.14.1 generalized behavioral contracts', () => {
    it('author and critic preserve exact attribution and decisive qualifiers without feature fusion', async () => {
      ...
      expect(bundle.metadata.promptVersion).toBe('2.14.1')
