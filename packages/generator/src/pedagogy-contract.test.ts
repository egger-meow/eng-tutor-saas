...
describe('Prompt 2.8.0 active invariant contract with frozen 2.4.0 through 2.7.0 inheritance', () => {
  ...
  it('uses CurriculumPackageSchema 2.3.0 while preserving V22, V21, and V20 legacy schemas', async () => {
    ...
    expect(bundle).toContain('bundleVersion: "2.8.0-prod"')
    expect(bundle).toContain('schemaVersion: "2.3.0"')
    expect(bundle).toContain('engineVersion: "1.4.0"')
