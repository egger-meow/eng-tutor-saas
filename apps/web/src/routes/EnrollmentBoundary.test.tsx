...
describe('public enrollment boundary matrix', () => {
  ...
  it('keeps the initial loading state neutral until enrollment authority responds', () => {
    const cta = getEnrollmentCta(null)
    const landing = renderToStaticMarkup(<LandingPage enrollment={null} />)
    const pricing = renderToStaticMarkup(<PricingSection enrollment={null} />)
