          ...
          <article className="legal-content">
            ...
            <section>
              ...
              <ol>
                ...
                <li>
                  <strong>創始 30 優惠（Founder 30）：</strong>創始 30 席次以實際成功啟用月繳訂閱之先後順序為準，限額 30 位孩子。建立孩子檔案或公測免費期間不預先保留或消耗創始席次。公測期間家長可自願提前啟用月繳訂閱以鎖定席次（立即開始計費）。優惠僅適用月繳：結帳時由系統取得 30 分鐘保留並完成月繳訂閱後，只要同一訂閱持續有效，每期固定為新臺幣 349 元（NT$349／月，由標準月費 NT$499 折抵 NT$150）。排定於期末取消不會立即失去優惠；在訂閱實際到期前恢復續訂，創始價格仍保留。只有訂閱實際成為 canceled 時，Founder 資格才永久失效，已兌換之席次亦不回補；之後重新訂閱依當時標準方案價格計費，且不得再次取得 Founder 資格。年繳方案不適用創始價格，亦不佔用創始席次。
                </li>
                <li>
                  <strong>公測免費階段與標準體驗：</strong>於歷史累計錄取滿 100 位學員以前，本服務處於免費公測階段，已錄取學員每週依回饋持續享有免費生成專屬教材之服務，無須填寫信用卡。公測結束後，恢復為標準第一週免費體驗（未付費體驗有效期間為建立後 14 日；逾 14 日未啟用正式訂閱者，系統釋出服務容量予候補家庭）。歷史已產生之每週教材與學習紀錄皆完整保留於家長後台。
                </li>
                <li>
