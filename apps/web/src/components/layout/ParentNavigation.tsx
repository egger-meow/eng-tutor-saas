...
export function ParentNavigation({ email, childHref = '/children', onSignOut }: ParentNavigationProps) {
  ...
  const navItems = [
    ...
    { href: '/assessment', label: '程度診斷', isActive: route.name === 'assessment' || route.name === 'child-assessment' },
    { href: '/announcements', label: '最新消息', isActive: route.name === 'announcements' || route.name === 'announcement-detail' },
